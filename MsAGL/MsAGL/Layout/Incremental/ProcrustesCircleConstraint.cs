...
namespace Microsoft.Msagl.Layout.Incremental {
    ...
    public class ProcrustesCircleConstraint : IConstraint {
        ...
        private static Point SingularValueDecomposition(Point[] X, out Point[] P, out Point[] Q) {
            ...
            if (!cmpEigenSystem(Q0, Q, l0, l)) {
                System.Debug.Write("XX=");
                printMatrix(XX);
                System.Debug.Write("Q0=");
                printMatrix(Q0);
                System.Debug.WriteLine("l0=" + l0 + ";");
                System.Debug.Write("Q=");
                printMatrix(Q);
                System.Debug.WriteLine("l=" + l + ";");
            }
            l = l0;
            Q = Q0;
            System.Debug.Write("Q=");
        ...
        public double Project() {
            ...
            //System.Debug.WriteLine("X=");
            //printMatrix(X);
            //System.Debug.WriteLine("Y=");
            //printMatrix(Y);
            //System.Debug.WriteLine("T=");
            //printMatrix(T);
            //System.Debug.WriteLine("s="+s);
            //System.Debug.WriteLine("t="+t);
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.Write(System.String,System.Object,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.Write(System.String)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String)")]
        public static void PrintMatrix(Point[] points) {
            ValidateArg.IsNotNull(points, "points");
            Debug.Write("{");
            for (int i = 0; i < points.Length;) {
                // FIXME Debug.Write("{{{0},{1}}}", points[i].X, points[i].Y);
                if (++i != points.Length) {
                    Debug.Write(",");
                }
            }
        ...
        //    System.Debug.Write("X="); printMatrix(X);
        //    Point[] P, Q;
        //    Point s = SingularValueDecomposition(X, out P, out Q);
        //    Point[] S = new Point[] { new Point(s.X, 0), new Point(0, s.Y) };
        //    System.Debug.Write("S="); printMatrix(S);
        //    System.Debug.Write("Q="); printMatrix(Q);
        //    System.Debug.Write("P="); printMatrix(P);
        //    Point[] R = matrixProductNoTranspose(P, S);
        //    System.Debug.Write("PS="); printMatrix(R);
        //    R = matrixProductNoTranspose(R, Transpose(Q));
        //    System.Debug.Write("R="); printMatrix(R);
  ...
  //      }  
        ///<summary>
        ///</summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1814:PreferJaggedArraysOverMultidimensional", MessageId = "Body"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String,System.Object,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.Write(System.String)")]
        public static void Test() {
