...
namespace Microsoft.Msagl.Layout.Incremental {
    ...
    public class FastIncrementalLayout : AlgorithmBase {
        ...
        double ComputeDescentDirection(double alpha) {
            ...
            //System.Debug.WriteLine("Iteration = {0}, Energy = {1}, StepSize = {2}", settings.maxIterations - settings.RemainingIterations, energy, stepSize);
            double lEnergy = 0;
            foreach (FiNode v in nodes) {
        ...
        double RungeKuttaIntegration() {
            ...
            UpdateStepSize(energy0);
            //System.Debug.WriteLine("energy0={0}, energy={1}, progress={2}, stepsize={3}", energy0, energy, progress, stepSize);
            SolveSeparationConstraints();
