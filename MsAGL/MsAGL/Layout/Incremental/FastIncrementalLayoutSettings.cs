...
//            }
        ...
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String)"), SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "FastIncrementalLayoutSettings"), SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "RemoveLock")]
        public void RemoveLock(LockPosition lockPosition) {
            ...
            if (lockPosition.listNode != null) {
                ...
                try {
                    ...
                    Debug.WriteLine("Problem in FastIncrementalLayoutSettings.RemoveLock "+e.Message);
                }
