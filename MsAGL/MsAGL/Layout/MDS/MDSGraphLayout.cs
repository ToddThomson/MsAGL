...
namespace Microsoft.Msagl.Layout.MDS
{
    ...
    public class MdsGraphLayout : AlgorithmBase
    {
        ...
        //    double[] x, y;
        //    System.Debug.WriteLine(group.Count);
        ...
        internal void LayoutConnectedComponents()
        {
            ...
            if ( settings.RunInParallel )
            {
                ...
                {
                    Debug.WriteLine( "laying out {0} connected component", i );
            ...
            Debug.WriteLine( "done with LayoutConnectedComponents" );
        }
        ...
        void AdjustScale( IList<Node> nodes )
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    //      Debug.WriteLine("reps={0} scale={1}, hits={2}", maxRepetitions-repetitions , scale, hits);
                    return;
                }
                delta /= 2;
