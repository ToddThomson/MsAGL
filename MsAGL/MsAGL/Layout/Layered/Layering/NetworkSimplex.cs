...
#if TEST_MSAGL
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String,System.Object,System.Object,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        void CheckCutValues() {
            foreach (NetworkEdge e in this.graph.Edges) {
                if (e.inTree) {
                    ...
                    if (e.Cut != cut)
                        Debug.WriteLine("cuts are wrong for {0}; should be {1} but is {2}", e, cut, e.Cut);
                }
