...
#if TEST_MSAGL
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.Write(System.String)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledCode")]
        static void PrintPositions(double[] positions) {
            for (int j = 0; j < positions.Length; j++)
                Debug.Write(" " + positions[j]);
            Debug.WriteLine("");
        }
#endif
