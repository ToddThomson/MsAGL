...
namespace Microsoft.Msagl.Core.GraphAlgorithms {
    internal class BasicGraph<TNode, TEdge> : BasicGraph<TEdge> where TEdge : IEdge
    {
        /// <summary>
        ...
        internal BasicGraph(IEnumerable<TEdge> edges) : base(edges, VertexCount(edges)) { }
    ...
    /// </summary>
    internal class BasicGraph<TEdge> where TEdge : IEdge {
        ...
        internal BasicGraph(IEnumerable<TEdge> edges) : this(edges, VertexCount(edges)) {}
        ...
        /// <param name="edges"></param>
        /// <param name="numberOfVerts"></param>
        internal BasicGraph(IEnumerable<TEdge> edges, int numberOfVerts) {
