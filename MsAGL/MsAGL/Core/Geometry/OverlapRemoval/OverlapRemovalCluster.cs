    ...
    public partial class OverlapRemovalCluster : OverlapRemovalNode
    {
...
#if VERBOSE
                Debug.WriteLine(" {0} After CalculateBorderWidths: p {1:F5} s {2:F5} pP {3:F5} sP {4:F5}"
...
#if VERBOSE
                    Debug.WriteLine(" {0} BoundaryRect after AddEvents: L/R T/B {1:F5}/{2:F5} {3:F5}/{4:F5}"
...
#if VERBOSE
                Debug.WriteLine(" {0} BoundaryRect after CreateEvents: L/R T/B {1:F5}/{2:F5} {3:F5}/{4:F5}"
                        , this.Name, boundaryRect.Left, boundaryRect.Right, boundaryRect.Top, boundaryRect.Bottom);
#endif
...
#if VERBOSE
                    Debug.WriteLine(" {0} MinClusterSizeCst {1} -> {2} g {3:F5}", isHorizontal ? "H" : "V"
                ...
                if (evt.IsForOpen)
                {
...
#if VERBOSE
                    Debug.WriteLine("ScanAdd: {0}", currentNode);
#endif // VERBOSE
                    ...
                    for (int ii = 0; ii < numLeftNeighbors; ++ii)
                    {
                        ...
                        {     // TODOunit: test this
                            ...
                            {
#if VERBOSE
                                Debug.WriteLine(" {0} RnbourRem {1} --> {2}", isHorizontal ? "H" : "V", leftNeighborNode, nodeToRemove);
#endif // VERBOSE
                            }
                        }
                    ...
                    {         // TODOunit: test this
                        ...
                        for (int jj = 0; jj < numLeftNeighbors; ++jj)
                        {
                            ...
                            {
#if VERBOSE
                                Debug.WriteLine(" {0} LnbourRem {1} --> {2}", isHorizontal ? "H" : "V", nodeToRemove, rightNeighborNode);
#endif // VERBOSE
                            }
                        }
...
#if VERBOSE
                        Debug.WriteLine(" {0} LnbourCst {1} -> {2} g {3:F5}", isHorizontal ? "H" : "V"
                                , cst.Left.Name, cst.Right.Name, cst.Gap);
#endif // VERBOSE
                    }
...
#if VERBOSE
                        Debug.WriteLine(" {0} RnbourCst {1} -> {2} g {3:F5}", isHorizontal ? "H" : "V"
                                , cst.Left.Name, cst.Right.Name, cst.Gap);
#endif // VERBOSE
                    }
...
#if VERBOSE
                    Debug.WriteLine("ScanRem: {0}", currentNode);
#endif // VERBOSE
                        ...
                        List<OverlapRemovalNode> neighbors, bool isLeftNeighbor, bool isHorizontal)
        {
            ...
            if (overlap <= 0)
            {
                ...
                {
#if VERBOSE
                    Debug.WriteLine(" V {0}nbourHTolSkipNO: {1}", isLeftNeighbor ? "L" : "R", nextNode);
#endif // VERBOSE
                    return true;
                }
                neighbors.Add(nextNode);
#if VERBOSE
                Debug.WriteLine("{0}nbourAddNO: {1}", isLeftNeighbor ? "L" : "R", nextNode);
#endif // VERBOSE
                return false;
            }
...
#if VERBOSE
                            Debug.WriteLine("{0}nbourDeferToV: {1}", isLeftNeighbor ? "L" : "R", nextNode);
#endif // VERBOSE
            ...
            else
            {
                ...
                {
#if VERBOSE
                    Debug.WriteLine(" V {0}nbourHTolSkipO: {1}", isLeftNeighbor ? "L" : "R", nextNode);
#endif // VERBOSE
                    return true;
                }
            }
            ...
            neighbors.Add(nextNode);
#if VERBOSE
            Debug.WriteLine("{0}nbourAddO: {1}", isLeftNeighbor ? "L" : "R", nextNode);
#endif // VERBOSE
            return true;
        }
