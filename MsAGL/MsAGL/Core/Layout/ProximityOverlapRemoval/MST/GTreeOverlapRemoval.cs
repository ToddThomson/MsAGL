    ...
    public class GTreeOverlapRemoval : IOverlapRemoval
    {
        ...
        public void RemoveOverlaps()
        {
            ...
            while ( OneIteration( nodePositions, nodeSizes, false ) )
            {
                ...
                //                    Debug.Write("removing overlaps with cdt only {0},", lastRunNumberIterations);
            }
            //        Debug.WriteLine();
            while ( OneIteration( nodePositions, nodeSizes, true ) )
            {
                lastRunNumberIterations++;
                //                Debug.Write("iterations with sweeping line {0},", lastRunNumberIterations);
            }
        ...
        */
            ...
            InitialScaling scalingMethod )
        {
            ...
            // TJJ: Why? Unreachable code below.
            return;
...
#if DEBUG
            Debug.WriteLine( "AvgEdgeLength Scaling Method: {0}, ScaleFactor={1:F2}", scalingMethod, scaling );
#endif
