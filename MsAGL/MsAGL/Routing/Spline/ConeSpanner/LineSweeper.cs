...
//                Show(EllipseOnVert(vertexEvent));
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization",
            "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String)"
            ),
         System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
            ...
            if (node != null) {
                ...
                if (coneRightSide != null) {
                    ...
                    if (Point.IntervalIntersectsRay(obstacleSideStart, obstacleSideVertex.Point,
                        ...
                        //                   Debug.WriteLine("right intersection");
        ...
        void PrintOutRightSegTree() {
            Debug.WriteLine("right segment tree");
            foreach (var t in rightConeSides)
                Debug.WriteLine(t);
            Debug.WriteLine("end of right segments");
        }
#endif
...
//                }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String,System.Object,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization",
            "CA1303:Do not pass literals as localized parameters", MessageId = "System.Debug.WriteLine(System.String)"
            )]
        void PrintOutLeftSegTree() {
            Debug.WriteLine("Left cone segments########");
            foreach (var t in leftConeSides) {
                var x = coneSideComparer.IntersectionOfSegmentAndSweepLine(t);

                Debug.WriteLine("{0} x={1}", t, x*DirectionPerp );                
            }
            Debug.WriteLine("##########end of left cone segments");
        }
#endif
