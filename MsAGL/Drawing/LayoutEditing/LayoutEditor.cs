...
namespace Microsoft.Msagl.Drawing {
    ...
    public class LayoutEditor {
        ...
        void HookUpToViewerEvents() {
            viewer.PointerPressed += ViewerMouseDown;
            viewer.PointerMoved += ViewerMouseMove;
            viewer.PointerReleased += ViewerMouseUp;
...
*/
        ...
        void ViewerMouseUp(object sender, MsaglPointerEventArgs args) {
            if (args.Handled) return;
            if (viewer.LayoutEditingEnabled)
                HandleMouseUpOnLayoutEnabled(args);
        }

        void HandleMouseUpOnLayoutEnabled(MsaglPointerEventArgs args) {
