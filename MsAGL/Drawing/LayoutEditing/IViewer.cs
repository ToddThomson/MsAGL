...
namespace Microsoft.Msagl.Drawing {
    ...
    public interface IViewer {
        ...
        /// </summary>
        event EventHandler<MsaglPointerEventArgs> PointerPressed;

        /// <summary>
        /// signalling the mouse move event
        /// </summary>
        event EventHandler<MsaglPointerEventArgs> PointerMoved;

        /// <summary>
        /// signalling the mouse up event
        /// </summary>
        event EventHandler<MsaglPointerEventArgs> PointerReleased;
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        Point ScreenToSource(MsaglPointerEventArgs e);
        ...
        void DrawRubberLine(MsaglPointerEventArgs args);
